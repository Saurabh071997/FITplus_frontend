    ...
    <div className="footer">
      <div className="footer-content">
        ...
        <div className="footer-content-txt">
          Sign up now and be the first to know about exclusive offers. With our
          upcoming trainer programme, you can now enjoy the benefits of home
          gym.
        </div>
      </div>
      ...
      <div className="footer-content">
        <div className="footer-content-txt">
          ...
          Arepo . Arepo's business concept is to offer health and quality at the
          best.
        </div>
        <div className="footer-app-name">FITplus</div>
